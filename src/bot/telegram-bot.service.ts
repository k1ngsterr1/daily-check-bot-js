...
**СИСТЕМА ДОСТИЖЕНИЙ:**
🥉 1 друг = +700 XP (500 + 200 бонус)
🥈 3 друга = +2200 XP (1500 + 500 + 200 бонусы)
🥇 5 друзей = +4200 XP (2500 + 1000 + 500 + 200 бонусы)

**УСЛОВИЯ:**
• Самоприглашение не засчитывается
• Бонусы начисляются сразу
• Активность друга отслеживается

*🚀 Цель: пригласить 5 друзей и получить все бонусы!*
        `,
        {
          reply_markup: {
            inline_keyboard: [
...
• "напомни позвонить маме через 30 минут"
  ...
  */
  ...
  private isReminderRequest(text: string): boolean {
    // Прямые напоминания со словом "напомни"
    ...
    const naturalTimePatterns = [
      ...
      /в\s*(\d{1,2}):(\d{2}).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "в 15:30 позвонить"

      // Паттерны с часами без минут
      /(утром|днем|вечером|ночью|сегодня|завтра|послезавтра).*в\s*(\d{1,2})\s*час/i, // "вечером в 8 часов"
      /в\s*(\d{1,2})\s*час.*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "в 8 часов позвонить"

      // Паттерны с относительным временем - расширенные
      /через\s*(\d+)\s*(минут|час|день|дня|дней|неделю|недели|недель|месяц|месяца|месяцев|год|года|лет).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "через неделю позвонить"
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*через\s*(\d+)\s*(минут|час|день|дня|дней|неделю|недели|недель|месяц|месяца|месяцев|год|года|лет)/i, // "позвонить через месяц"

      // Паттерны со специфическими временными выражениями
      /(завтра|послезавтра).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "завтра позвонить"
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*(завтра|послезавтра)/i, // "позвонить завтра"
      /на\s*следующей\s*неделе.*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "на следующей неделе позвонить"
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*на\s*следующей\s*неделе/i, // "позвонить на следующей неделе"
      /в\s*следующем\s*месяце.*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "в следующем месяце позвонить"
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*в\s*следующем\s*месяце/i, // "позвонить в следующем месяце"

      // Простые паттерны с действиями и временем
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*(\d{1,2}):(\d{2})/i, // "отправить письмо 23:00"
      /(\d{1,2}):(\d{2}).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i, // "23:00 отправить письмо"
      /(утром|днем|вечером|ночью).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*(\d{1,2}):(\d{2})/i, // "вечером отправить письмо 23:00"
    ];
  ...
  private isTaskRequest(text: string): boolean {
    ...
    const taskPatterns = [
      ...
      /(завтра|послезавтра|сегодня|в понедельник|во вторник|в среду|в четверг|в пятницу|в субботу|в воскресенье)\s+(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать)/i,
      ...
      /через\s*(\d+)\s*(минут|час|день|дня|дней|неделю|недели|недель|месяц|месяца|месяцев|год|года|лет)\s*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать)/i,
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать).*через\s*(\d+)\s*(минут|час|день|дня|дней|неделю|недели|недель|месяц|месяца|месяцев|год|года|лет)/i,
      /(завтра|послезавтра)\s*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать)/i,
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать).*(завтра|послезавтра)/i,
      /на\s*следующей\s*неделе\s*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать)/i,
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать).*на\s*следующей\s*неделе/i,
      /в\s*следующем\s*месяце\s*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать)/i,
      /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать).*в\s*следующем\s*месяце/i,
    ];
