...
• "напомни позвонить маме через 30 минут"
    ...
    isReminderRequest(text) {
        ...
        const naturalTimePatterns = [
            ...
            /через\s*(\d+)\s*(минут|час).*(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать)/i,
            /(сделать|выполнить|купить|позвонить|написать|отправить|подготовить|организовать|запланировать|встретить|пойти|поехать).*через\s*(\d+)\s*(минут|час)/i,
        ];
    ...
    isTaskRequest(text) {
        ...
        const hasTimeExclusions = timeExclusions.some((pattern) => pattern.test(text));
